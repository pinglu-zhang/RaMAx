...
- [Usage guide](usage.md): input format, MAF and HAL commands, optimization
...
- [Output formats](output-formats.md): MAF/HAL conventions, validation, and
...
- [Realignment architecture](realignment_architecture.md): execution order,
  graph transactions, external MSA handling, and MAF/HAL consistency.
